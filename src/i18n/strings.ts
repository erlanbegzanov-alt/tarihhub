...
export const s = {
  ...
  /**
   * Friends (`/battle/friends`, see src/lib/friends.ts). Added by personal code
   * only — the copy says so plainly, because "why can't I search by name" is
   * the first question a child will ask.
   */
  friends: {
    title: { kz: 'Достар', ru: 'Друзья' },
    subtitle: {
      kz: 'Код арқылы қос, бірге ойна',
      ru: 'Добавляй по коду, играй вместе',
    },
    hubSub: {
    ...
    myCodeHint: {
      kz: 'Осы кодты досыңа бер. Сені тек осы код арқылы табуға болады — атың бойынша іздеу жоқ.',
      ru: 'Дай этот код другу. Найти тебя можно только по нему — поиска по имени нет.',
    },
    codeLoading: { kz: 'Код дайындалып жатыр…', ru: 'Готовим код…' },
    codeFailed: {
      kz: 'Кодты алу мүмкін болмады. Бетті жаңартып көр.',
      ru: 'Не удалось получить код. Обнови страницу.',
    },
    copy: { kz: 'Көшіру', ru: 'Копировать' },
    copied: { kz: 'Көшірілді', ru: 'Скопировано' },

    addTitle: { kz: 'Дос қосу', ru: 'Добавить друга' },
    addPlaceholder: { kz: 'Мысалы, K7PM-X2QD', ru: 'Например, K7PM-X2QD' },
    addButton: { kz: 'Қосу', ru: 'Добавить' },
    resultSent: {
      kz: 'Сұрау жіберілді. Досың қабылдағанда тізімде пайда болады.',
      ru: 'Запрос отправлен. Друг появится в списке, когда примет его.',
    },
    resultAccepted: {
      kz: 'Ол саған бұрын сұрау жіберген екен — енді сендер доссыңдар!',
      ru: 'Он уже отправлял тебе запрос — теперь вы друзья!',
    },
    resultAlready: { kz: 'Бұл адам қазірдің өзінде досың.', ru: 'Этот человек уже у тебя в друзьях.' },
    resultPending: { kz: 'Сұрау жіберілген, жауабын күт.', ru: 'Запрос уже отправлен, ждём ответа.' },
    resultSelf: { kz: 'Бұл — сенің өз кодың.', ru: 'Это твой собственный код.' },
    resultNotFound: {
      kz: 'Мұндай код табылмады. Әріптерді тексер.',
      ru: 'Такого кода нет. Проверь буквы.',
    },
    resultInvalid: {
      kz: 'Код 8 таңбадан тұрады: әріптер мен сандар.',
      ru: 'Код — это 8 символов: буквы и цифры.',
    },
    resultError: {
      kz: 'Жіберілмеді. Интернетті тексеріп, қайталап көр.',
      ru: 'Не получилось отправить. Проверь интернет и попробуй ещё раз.',
    },

    incomingTitle: { kz: 'Сұраулар', ru: 'Запросы в друзья' },
    accept: { kz: 'Қабылдау', ru: 'Принять' },
    decline: { kz: 'Бас тарту', ru: 'Отклонить' },
    outgoingTitle: { kz: 'Жауап күтуде', ru: 'Ждут ответа' },
    cancel: { kz: 'Болдырмау', ru: 'Отменить' },

    listTitle: { kz: 'Достарым', ru: 'Мои друзья' },
    empty: {
      kz: 'Әзірге достар жоқ. Кодыңды досыңа жібер немесе оның кодын жоғарыға енгіз.',
      ru: 'Пока друзей нет. Отправь свой код другу или введи его код выше.',
    },
    online: { kz: 'желіде', ru: 'в сети' },
    /** Precedes a relative time, e.g. "был(а) 2 ч назад". */
    lastSeen: { kz: 'соңғы рет', ru: 'был(а)' },
    remove: { kz: 'Өшіру', ru: 'Удалить' },
    removeConfirm: { kz: 'Шынымен өшіру керек пе?', ru: 'Точно удалить из друзей?' },
    teamSoon: {
      kz: 'Жақында: достардан команда жинап, 2×2 … 5×5 ойнайсыңдар.',
      ru: 'Скоро: собирайте команду из друзей и играйте 2×2 … 5×5.',
    },
    signInNeeded: {
      kz: 'Достар тек аккаунтқа кіргенде жұмыс істейді.',
      ru: 'Друзья работают только после входа в аккаунт.',
    },
    loadFailed: {
      kz: 'Тізімді жүктеу мүмкін болмады. Интернетті тексер.',
      ru: 'Не удалось загрузить список. Проверь интернет.',
    },
  },

  /**
   * Team battle — gathering the party (`/battle/team`, see src/lib/party.ts).
   * The queue splits four ways (2х2 … 5х5), so the picker says out loud how
   * many people are waiting in each: an honest "nobody here yet" beats a
  ...
  kahoot: {
    ...
    loadFailed: {
      kz: 'Ойынды жүктеу мүмкін болмады. Қайта кіріп көріңіз — бос үлгіні сақтамаңыз, ол бар сұрақтарды алмастырып жібереді.',
      ru: 'Не удалось загрузить игру. Попробуйте зайти снова — не сохраняйте пустой черновик, он заменит собой все вопросы.',
    },
    subtitle: {
  ...
  /**
   * The ҰБТ mock. The wording here is deliberately careful about what is the
   * exam's rule and what is ours: the 40 minutes are our pace, the threshold
   * of 5 and the absence of negative marking are the exam's.
   */
  exam: {
    title: { kz: 'ҰБТ сынағы', ru: 'Пробник ҰБТ' },
    subtitle: {
      kz: '20 тапсырма: 10 жеке және 5 тапсырмадан тұратын 2 контекст',
      ru: '20 заданий: 10 отдельных и 2 контекста по 5',
    },
    hubSub: {
      kz: 'Нақты формат бойынша толық нұсқа',
      ru: 'Полный вариант по настоящему формату',
    },

    briefTitle: { kz: 'Бастамас бұрын', ru: 'Перед началом' },
    briefFormat: {
      kz: '№1–10 — жеке тапсырмалар. №11–15 және №16–20 — әрқайсысы бір мәтінге құрылған екі контекст. Бір контексттегі тапсырмалар өзара байланысты: мәтінді қате түсінсең, бірнеше балл бірден кетеді.',
      ru: '№1–10 — отдельные задания. №11–15 и №16–20 — два контекста, каждый по одному тексту. Задания внутри контекста связаны: не так понял текст — теряешь несколько баллов сразу.',
    },
    briefTime: {
      kz: '40 минут — бұл біздің қарқын өлшеуішіміз, экзаменнің ережесі емес: ҰБТ-да тарихқа бөлек таймер жоқ, барлық пәнге жалпы 240 минут беріледі.',
      ru: '40 минут — это наш ориентир по темпу, а не правило экзамена: на ҰБТ отдельного таймера по истории нет, на все предметы даётся 240 минут.',
    },
    briefThreshold: {
      kz: 'Тарих бойынша жеке шек — 20 баллдың 5-еуі. Одан төмен болса, ҰБТ нәтижесі мүлде есептелмейді.',
      ru: 'Индивидуальный порог по истории — 5 из 20. Ниже него результат ЕНТ не засчитывается вообще.',
    },
    briefBlank: {
      kz: 'Дұрыс емес жауап үшін балл алынбайды, сондықтан бос қалдырғаннан гөрі кез келген нұсқаны таңдаған дұрыс.',
      ru: 'За неверный ответ балл не снимают, поэтому пустой ответ всегда хуже любого выбранного.',
    },
    start: { kz: 'Бастау', ru: 'Начать' },

    counter: { kz: 'тапсырма', ru: 'задание' },
    contextOne: { kz: 'Контекст 1 · №11–15', ru: 'Контекст 1 · №11–15' },
    contextTwo: { kz: 'Контекст 2 · №16–20', ru: 'Контекст 2 · №16–20' },
    showPassage: { kz: 'Мәтінді көрсету', ru: 'Показать текст' },
    hidePassage: { kz: 'Мәтінді жасыру', ru: 'Скрыть текст' },
    prev: { kz: 'Артқа', ru: 'Назад' },
    next: { kz: 'Әрі қарай', ru: 'Дальше' },
    finish: { kz: 'Аяқтау', ru: 'Завершить' },
    noFeedbackNote: {
      kz: 'Жауаптардың дұрыс-бұрысы соңында көрсетіледі — нақты экзамендегідей.',
      ru: 'Верно или нет — покажем в конце, как на настоящем экзамене.',
    },
    blankWarnTitle: { kz: 'Бос тапсырмалар бар', ru: 'Есть пустые задания' },
    blankWarnText: {
      kz: 'Жауапсыз қалған тапсырма саны:',
      ru: 'Заданий осталось без ответа:',
    },
    blankWarnHint: {
      kz: 'Теріс балл жоқ, сондықтан әрқайсысында бір нұсқаны таңдаған тиімдірек.',
      ru: 'Отрицательного балла нет, поэтому в каждом выгоднее выбрать хоть какой-то вариант.',
    },
    backToBlank: { kz: 'Бос тапсырмаға өту', ru: 'Перейти к пустому' },
    finishAnyway: { kz: 'Бәрібір аяқтау', ru: 'Всё равно завершить' },
    timeUp: { kz: 'Уақыт бітті', ru: 'Время вышло' },
    timeUpText: {
      kz: '40 минуттық бағдарымыз аяқталды, сынақ автоматты түрде жабылды.',
      ru: 'Наш ориентир в 40 минут закончился, пробник закрылся автоматически.',
    },

    resultTitle: { kz: 'Сынақ нәтижесі', ru: 'Результат пробника' },
    score: { kz: 'Балл', ru: 'Балл' },
    thresholdOk: {
      kz: '5 баллдық жеке шектен өттің.',
      ru: 'Индивидуальный порог в 5 баллов пройден.',
    },
    thresholdFail: {
      kz: 'Жеке шек — 5 балл. Нақты ҰБТ-да мұндай нәтижемен қорытынды есептелмейді.',
      ru: 'Индивидуальный порог — 5 баллов. На настоящем ҰБТ с таким результатом итог не засчитали бы.',
    },
    blankLeft: { kz: 'Бос қалды', ru: 'Осталось пустыми' },
    blankCost: {
      kz: 'Бос жауап — тегін жоғалтылған балл: теріс балл жоқ.',
      ru: 'Пустой ответ — это балл, потерянный даром: отрицательного балла нет.',
    },

    mixTitle: { kz: 'Нұсқаның күрделілігі', ru: 'Сложность варианта' },
    mixTarget: { kz: 'Спецификация бойынша', ru: 'По спецификации' },
    mixThis: { kz: 'Осы нұсқада', ru: 'В этом варианте' },
    mixHonest: {
      kz: 'Банкте C деңгейіндегі жеке сұрақтар әлі жеткіліксіз, сондықтан пропорция дәл келмеуі мүмкін. Айырмашылықты жасырмаймыз.',
      ru: 'В банке пока не хватает отдельных вопросов уровня C, поэтому пропорция может не сойтись точно. Расхождение не прячем.',
    },

    byTopic: { kz: 'Кодификатор тақырыптары бойынша', ru: 'По темам кодификатора' },
    byPattern: { kz: 'Тапсырма түрлері бойынша', ru: 'По типам заданий' },
    byLevel: { kz: 'Деңгейлер бойынша', ru: 'По уровням' },
    weakestFirst: { kz: 'Әлсізінен басталады', ru: 'Сначала самое слабое' },

    reviewTitle: { kz: 'Тапсырмаларды талдау', ru: 'Разбор заданий' },
    yourAnswer: { kz: 'Сенің жауабың', ru: 'Твой ответ' },
    correctAnswer: { kz: 'Дұрыс жауап', ru: 'Верный ответ' },
    leftBlank: { kz: 'Жауапсыз қалды', ru: 'Осталось без ответа' },

    retry: { kz: 'Жаңа нұсқа', ru: 'Новый вариант' },
    toBattle: { kz: 'Батлға қайту', ru: 'Вернуться в Батл' },
  },
}
